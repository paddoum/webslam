...
// Stamp the build info (date + git hash, from version.js — regenerated by
// build.sh) into the header so you can confirm the running version.
{ const b = document.getElementById('build'); if (b) b.textContent = `build ${BUILD}`; }
